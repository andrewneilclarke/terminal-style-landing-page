(function () {
    ...
    function c(d) {
      ...
      if (a.min) a.minimize();
        ...
        a.max ||
          ...
          (y = d.touches) && (y = y[0]) ? ((d = y), m(window, 'touchmove', g), m(window, 'touchend', f)) : (m(window, 'mousemove', g), m(window, 'mouseup', f)),
          (J = d.pageX),
          (F = d.pageY),
          a.focus());
      }
    ...
    function g(d) {
      ...
      if (K || r)
        K && (a.width = Math.max(Math.min(a.width, P - a.x - a.right), 150)),
          ...
          a.resize();
      if (A || v)
        A && (a.x = Math.max(Math.min(a.x, P - a.width - a.right), a.left)), v && (a.y = Math.max(Math.min(a.y, Q - a.height - a.bottom), a.top)), a.move();
      J = z;
      F = d;
    }
    function f(d) {
  ...
  e.minimize = function (a) {
    ...
    !a && this.min
      ...
      : !1 === a || this.min || (w.push(this), V(), (this.g.title = this.title), this.addClass('min'), (this.min = !0));
  ...
  e.move = function (a, b, c) {
    a || 0 === a
      ? c || ((this.x = a ? (a = U(a, P - this.left - this.right, this.width)) : 0), (this.y = b ? (b = U(b, Q - this.top - this.bottom, this.height)) : 0))
      : ((a = this.x), (b = this.y), this.v && (0 === a ? this.resize(P / 2, Q) : a === P - this.width && this.resize(P / 2, Q)));
  ...
  e.resize = function (a, b, c) {
    a || 0 === a
      ? c || ((this.width = a ? (a = U(a, P - this.left - this.right)) : 0), (this.height = b ? (b = U(b, Q - this.top - this.bottom)) : 0))
